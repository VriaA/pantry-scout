    ...
    if (!recipes) {
        ...
        return (
            <Container sx={{ display: 'flex', flexDirection: 'column', height: '100svh', alignItems: 'center' }}>
                <header className="flex-none w-full flex flex-wrap h-fit items-center justify-between py-5 gap-3 md:gap-0">
                    <h1 className="order-1 w-fit font-melodrama text-5xl text-center text-zinc-900">Recipe</h1>
                ...
                <main className="w-fit py-10">
                    <article className="flex flex-col gap-5 w-full md:max-w-2xl">
                        <section className="flex flex-col gap-3">
                            <h2 className="font-melodrama text-4xl text-center text-zinc-900">{name}</h2>
